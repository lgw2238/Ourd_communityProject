...
import com.ourd.exception.AttachFileException;
...
public class FileUtils {
	...
	/** 업로드 경로 */
	private final String uploadPath = Paths.get("C:", "Users", "LGW", "springboot", "ourd-2", "src", "main", "resources", "static", "images").toString();
